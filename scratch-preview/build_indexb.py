...
@media(max-width:920px){
  ...
  .hero.xb .xb-pbig{position:absolute;left:10px;top:50%%;height:288px;margin:0;transform:translateY(-50%%);z-index:2;filter:drop-shadow(0 16px 44px rgba(255,23,63,.45));}
