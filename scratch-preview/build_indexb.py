...
@media(max-width:920px){
  .hero.xb .xb-hc{grid-template-columns:1fr;justify-items:center;text-align:center;padding-top:100px;padding-bottom:40px;}
  .hero.xb .xb-d{display:none;} .hero.xb .xb-m{display:block;}
  .hero.xb .xb-pbig{height:150px;left:50%%;top:13%%;transform:translate(-50%%,-50%%);}
  .hero.xb .xb-left{padding-left:0;} .hero.xb .xb-left h1{font-size:56px;}
  .hero.xb .xb-left .xb-sub{margin-left:auto;margin-right:auto;}
  .hero.xb .xb-card{justify-self:stretch;max-width:440px;text-align:left;}
}
...
f.write_text(html)
print("index-b.html updated;", round(len(html)/1024), "KB")
