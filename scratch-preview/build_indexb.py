...
@media(max-width:920px){
  ...
  .hero.xb .xb-pbig{position:absolute;left:10px;top:50%%;height:240px;margin:0;transform-origin:left center;transform:translateY(calc(-50%% - 80px)) scaleX(.86);z-index:2;filter:drop-shadow(0 16px 44px rgba(255,23,63,.45));}
  .hero.xb .xb-left{width:100%%;box-sizing:border-box;padding:0;margin:0;position:relative;z-index:5;display:block;text-align:center;transform:translateY(-88px);}
