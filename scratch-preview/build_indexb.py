...
@media(max-width:920px){
  ...
  .hero.xb .xb-pbig{position:absolute;left:10px;top:50%%;height:240px;margin:0;transform-origin:left center;transform:translateY(calc(-50%% - 38px)) scaleX(.86);z-index:2;filter:drop-shadow(0 16px 44px rgba(255,23,63,.45));}
...
HERO = '''<header class="hero xb" id="top">
  <video class="xb-hbg" id="xbHeroVid" autoplay muted loop playsinline preload="auto" poster="assets/hero-video-poster.webp" data-vm="assets/hero-video-mobile.mp4" data-vd="assets/hero-video-desktop.mp4"></video>
  <script>(function(){var v=document.getElementById('xbHeroVid');if(!v)return;var src=window.matchMedia('(max-width:920px)').matches?v.dataset.vm:v.dataset.vd;var s=document.createElement('source');s.type='video/mp4';s.src=src;v.appendChild(s);v.load();var p=v.play&&v.play();if(p&&p.catch)p.catch(function(){});})();</script>
