...
@media(max-width:920px){
  ...
  .hero.xb .xb-hbg{height:100svh;bottom:auto;}
  .hero.xb .xb-hc{display:flex;flex-direction:column;align-items:center;text-align:center;min-height:100svh;padding:0;gap:0;}
  .hero.xb .xb-stage{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100svh;width:100%%;box-sizing:border-box;padding:0 6px;overflow:hidden;}
  .hero.xb .xb-pbig{position:static;transform:none;height:322px;margin:0;filter:drop-shadow(0 18px 48px rgba(255,23,63,.45));}
  .hero.xb .xb-left{width:100%%;box-sizing:border-box;padding:0;margin-top:-124px;position:relative;z-index:5;display:block;}
  .hero.xb .xb-left h1{font-size:68px;line-height:.84;letter-spacing:-0.012em;text-shadow:0 6px 30px rgba(0,0,0,.65);}
  .hero.xb .xb-left .xb-sub{margin:16px auto 0;max-width:320px;font-size:13.5px;}
  .hero.xb .xb-card{position:relative;z-index:5;justify-self:auto;margin:28px auto 44px;max-width:400px;width:calc(100%% - 36px);padding:18px;text-align:left;}
