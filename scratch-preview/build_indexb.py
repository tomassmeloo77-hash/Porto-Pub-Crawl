...
@media(max-width:920px){
  ...
  .hero.xb .xb-stage{display:contents;}
  .hero.xb .xb-hc{display:flex;flex-direction:column;justify-content:center;align-items:stretch;text-align:left;min-height:100svh;padding:0;position:relative;gap:0;}
  .hero.xb .xb-pbig{position:absolute;left:-58px;top:50%%;height:300px;margin:0;transform:translateY(-50%%);z-index:2;filter:drop-shadow(0 16px 44px rgba(255,23,63,.45));}
  .hero.xb .xb-left{width:auto;box-sizing:border-box;padding:0 16px 0 84px;margin:0;position:relative;z-index:5;display:block;text-align:left;transform:translateY(-10px);}
  .hero.xb .xb-left h1{font-size:47px;line-height:.86;text-align:left;text-shadow:0 6px 30px rgba(0,0,0,.65);}
  .hero.xb .xb-left .xb-sub{margin:14px 0 0;max-width:290px;font-size:12.5px;text-align:left;}
