...
@media(max-width:920px){
  ...
  .hero.xb .xb-pbig{position:absolute;left:50%%;top:50%%;height:216px;margin:0;transform:translate(-50%%,-250px);z-index:4;filter:drop-shadow(0 16px 44px rgba(255,23,63,.45));}
