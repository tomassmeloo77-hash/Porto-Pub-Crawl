...
@media(max-width:920px){
  ...
  .hero.xb .xb-hc{display:flex;flex-direction:column;justify-content:flex-start;align-items:center;text-align:center;min-height:100svh;padding:0 20px 30px;}
  .hero.xb .xb-pbig{position:absolute;left:50%%;top:3%%;transform:translateX(-50%%);height:min(72vw,300px);filter:drop-shadow(0 16px 40px rgba(255,23,63,.4));}
  .hero.xb .xb-left{padding-left:0;position:relative;z-index:5;margin-top:25vh;}
