...
@media(max-width:920px){
  ...
  .hero.xb .xb-hc{display:flex;flex-direction:column;justify-content:flex-start;align-items:center;text-align:center;min-height:100svh;padding:134px 18px 18px;gap:0;}
