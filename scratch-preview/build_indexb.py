...
@media(max-width:920px){
  ...
  .hero.xb .xb-pbig{position:absolute;left:10px;top:50%%;height:240px;margin:0;transform:translateY(calc(-50%% - 38px));z-index:2;filter:drop-shadow(0 16px 44px rgba(255,23,63,.45));}
