...
def pmark(fill='currentColor'):
    return '<svg class="pmark" viewBox="0 0 1021 838" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><g transform="translate(45,768) scale(1,-1)"><path d="'+PATH+'" fill="'+fill+'"/></g></svg>'
def pmark_grad(gid):
    return ('<svg class="pmark" viewBox="0 0 1021 838" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">'
      '<defs><linearGradient id="'+gid+'" x1="0" y1="0" x2="1" y2="1">'
      '<stop offset="0" stop-color="#ff173f"/><stop offset="1" stop-color="#7a0a1f"/></linearGradient></defs>'
      '<g transform="translate(45,768) scale(1,-1)"><path d="'+PATH+'" fill="url(#'+gid+')"/></g></svg>')
PM=pmark()

PANEL=r"""<aside class="panel">
  <div class="ptop"><div class="brandmark">__PM__</div>
...
h1{font-family:var(--disp);font-weight:400;text-transform:uppercase;letter-spacing:.005em;color:#fff;line-height:.86;text-shadow:0 4px 24px rgba(0,0,0,.4);}
...
.panel .brandmark{color:var(--pink);height:30px;display:flex;align-items:center;}.panel .brandmark .pmark{height:30px;}
...
.subline{display:block;color:#fff;}

/* ===== W1 — drop-cap P ===== */
.w1 h1{display:flex;align-items:center;gap:.12em;font-size:clamp(44px,6vw,92px);}
.w1 .bigP{color:var(--pink);height:2.0em;filter:drop-shadow(0 8px 26px rgba(255,23,63,.45));flex:none;}
.w1 .bigP .pmark{height:100%;}
.w1 .rest{line-height:.82;}
/* ===== W2 — twin P ===== */
.w2 h1{font-size:clamp(46px,6.4vw,100px);}
.w2 .pmark{color:var(--pink);height:.9em;margin-right:.02em;filter:drop-shadow(0 4px 16px rgba(255,23,63,.4));}
/* ===== W3 — gold glow P ===== */
.w3 h1{font-size:clamp(46px,6.4vw,100px);}
.w3 .word{display:flex;align-items:center;}
.w3 .word .pmark{color:var(--gold);height:.92em;margin-right:.02em;filter:drop-shadow(0 0 24px rgba(255,196,102,.6));animation:glow 3s ease-in-out infinite;}
@keyframes glow{0%,100%{filter:drop-shadow(0 0 18px rgba(255,196,102,.45));}50%{filter:drop-shadow(0 0 34px rgba(255,196,102,.85));}}
/* ===== W4 — gradient P + tight stack ===== */
.w4 h1{font-size:clamp(48px,6.6vw,104px);line-height:.82;}
.w4 .word{display:flex;align-items:center;}
.w4 .word .pmark{height:.94em;margin-right:.02em;}
/* ===== W5 — monogram-led ===== */
.w5 .mono-lead{color:var(--pink);height:clamp(90px,13vw,190px);margin-bottom:18px;filter:drop-shadow(0 14px 40px rgba(255,23,63,.5));}
.w5 .mono-lead .pmark{height:100%;}
.w5 h1{font-size:clamp(40px,5.4vw,84px);line-height:.84;}
.w5 h1 .thin{-webkit-text-stroke:1.6px rgba(245,244,242,.55);color:transparent;}
...
<div class="tagline">P2 explorado · o P como letra <b id="tl">W1 · Drop-cap P</b> · preview local</div>
<div class="deck">

  <!-- W1 drop-cap -->
  <section class="slide active split w1" data-name="W1 · Drop-cap P">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
      <div class="eyebrow"><span class="live"></span> The Original Since 2025</div>
      <h1><span class="bigP">__PM__</span><span class="rest">ORTO<br>PUB&nbsp;CRAWL</span></h1>
  ...
  <!-- W2 twin P -->
  <section class="slide split w2" data-name="W2 · P duplo (Porto + Pub)">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
      <div class="eyebrow"><span class="live"></span> Porto's #1 Pub Crawl</div>
      <h1>__PM__ORTO<br>__PM__UB CRAWL</h1>
  ...
  <!-- W3 gold glow -->
  <section class="slide split w3" data-name="W3 · P dourado com glow">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
      <div class="eyebrow"><span class="live"></span> Live tonight · 9PM · Porto</div>
      <h1><span class="word">__PM__ORTO</span><span class="subline">Pub Crawl</span></h1>
      <p class="sub">Guided bar-hop, free shots, VIP club entry and a crowd from 60+ countries.</p>
    </div>__PANEL__</div>
   </div>
  </section>

  <!-- W4 gradient P -->
  <section class="slide split w4" data-name="W4 · P em gradiente">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
      <div class="eyebrow"><span class="live"></span> Project P · Porto</div>
      <h1><span class="word">__PGRAD__ORTO</span><span class="subline">Pub Crawl</span></h1>
  ...
  <!-- W5 monogram-led -->
  <section class="slide split w5" data-name="W5 · Monograma no topo">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
      <div class="mono-lead">__PM__</div>
      <h1>Porto<br><span class="thin">Pub Crawl</span></h1>
      <p class="sub">One wristband does it all. Porto's craziest night, sorted.</p>
    </div>__PANEL__</div>
   </div>
  </section>
</div>
...
<nav class="switch">
  <button class="on" data-i="0">W1 Drop-cap</button>
  <button data-i="1">W2 Duplo</button>
  <button data-i="2">W3 Dourado</button>
  <button data-i="3">W4 Gradiente</button>
  <button data-i="4">W5 Monograma</button>
</nav>
...
"""
html=html.replace("__PANEL__",PANEL).replace("__PGRAD__",pmark_grad("pg1")).replace("__PM__",PM)
...
out=base/"hero-p2-preview.html";out.write_text(html)
