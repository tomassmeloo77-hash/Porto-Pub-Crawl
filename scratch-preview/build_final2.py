...
# authentic brand marks (real colours)
...
TRUSTPILOT_STAR='<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="#00B67A" d="M12 1.5l3.09 6.26 6.91 1-5 4.87 1.18 6.87L12 17.25l-6.18 3.25L7 13.63l-5-4.87 6.91-1L12 1.5z"/></svg>'

PANEL=r"""<aside class="panel">
  <div class="phead">
    <div class="badges">
      <span class="bg">__GOOGLE__ <span>Google</span></span>
      <span class="bg">__TP__ <span>Trustpilot</span></span>
    </div>
...
</aside>""".replace("__GOOGLE__",GOOGLE_C).replace("__TP__",TRUSTPILOT_STAR)
...
.rate{display:inline-flex;align-items:center;gap:7px;}
.rate .stars{font-size:12px;}.rate .rnum{font-family:var(--disp);font-size:17px;color:var(--cream);}
...
/* ===== 5 near-identical P variants ===== */
.p1 .pbig{height:clamp(250px,34vw,470px);left:clamp(12px,2vw,42px);}
.p2 .pbig{height:clamp(270px,37vw,510px);left:clamp(10px,1.8vw,38px);}                 /* slightly bigger */
.p3 .pbig{height:clamp(240px,32vw,440px);left:clamp(20px,3vw,58px);}                   /* a touch smaller + more margin */
.p4 .pbig{height:clamp(255px,35vw,485px);left:clamp(12px,2vw,42px);top:44%;}           /* nudged up */
.p5 .pbig{height:clamp(255px,35vw,485px);left:clamp(10px,1.8vw,40px);transform:translateY(-50%) rotate(-4deg);} /* subtle tilt */
...
<div class="tagline">D4 · sem eyebrow · selos reais · P grande — micro-variações <b id="tl">P1</b> · preview local</div>
<div class="deck">
"""
SLIDE=r"""
...
"""
variants=[("p1","P1 · base"),("p2","P2 · um pouco maior"),("p3","P3 · menor + mais margem"),
          ("p4","P4 · ligeiramente acima"),("p5","P5 · leve inclinação")]
...
<nav class="switch">
  <button class="on" data-i="0">P1 base</button>
  <button data-i="1">P2 maior</button>
  <button data-i="2">P3 margem</button>
  <button data-i="3">P4 acima</button>
  <button data-i="4">P5 inclinado</button>
</nav>
<script>
...
out=base/"hero-final2-preview.html";out.write_text(html)
