...
/* ===== M5 (P selo no topo) — puxado ligeiramente para baixo ===== */
.m1 .pbig{height:200px;left:50%;top:19%;transform:translate(-50%,-50%);}   /* um pouco para baixo */
.m2 .pbig{height:200px;left:50%;top:23%;transform:translate(-50%,-50%);}   /* mais para baixo */
.m3 .pbig{height:200px;left:50%;top:27%;transform:translate(-50%,-50%);}   /* ainda mais */
.m4 .pbig{height:220px;left:50%;top:24%;transform:translate(-50%,-50%);}   /* + baixo, ligeiramente maior */
.m5 .pbig{height:200px;left:50%;top:15%;transform:translate(-50%,-50%);}   /* original (referência) */
...
<div class="head"><div class="k">PORTO <b>PUB CRAWL</b> · mobile · M5 · ajustar altura do P</div>
<h1>Mobile M5 — P puxado para baixo</h1>
<p>Todas com o P cheio no topo, só a variar quanto desce. A = original, depois cada vez mais para baixo.</p></div>
...
<nav class="switch">
  <button data-m="5">Original</button>
  <button class="on" data-m="1">↓ um pouco</button>
  <button data-m="2">↓ mais</button>
  <button data-m="3">↓ ainda mais</button>
  <button data-m="4">↓ + maior</button>
</nav>
...
out=base/"hero-m5-preview.html";out.write_text(page)
