...
.bigP,.leadP{color:var(--pink);filter:drop-shadow(0 10px 30px rgba(255,23,63,.5));flex:none;}
...
.left .sub{margin-top:24px;max-width:440px;font-size:clamp(15px,1.5vw,18px);color:#eceaeb;}
h1{font-family:var(--disp);font-weight:400;text-transform:uppercase;letter-spacing:.005em;color:#fff;line-height:.84;text-shadow:0 4px 24px rgba(0,0,0,.4);}
...
/* D1 — inline drop-cap in PORTO */
.d1 h1{display:flex;align-items:center;gap:.1em;font-size:clamp(46px,6.4vw,102px);}
.d1 .bigP{height:2.0em;}.d1 .rest{line-height:.8;}
/* D2 — giant graphic P + wordmark beside */
.d2 .lockup{display:flex;align-items:center;gap:clamp(18px,2.5vw,40px);}
.d2 .leadP{height:clamp(120px,17vw,260px);}
.d2 .wcol .kick{font-family:var(--mono);font-size:12px;letter-spacing:.24em;text-transform:uppercase;color:var(--pink-soft);margin-bottom:12px;}
.d2 h1{font-size:clamp(38px,5vw,80px);line-height:.82;}
/* D3 — P as huge letter, ORTO same size */
.d3 h1{font-size:clamp(52px,8.5vw,150px);line-height:.82;}
.d3 .word{display:flex;align-items:center;}
.d3 .word .pmark{height:.9em;color:var(--pink);margin-right:.015em;filter:drop-shadow(0 10px 30px rgba(255,23,63,.5));}
.d3 .subline{-webkit-text-stroke:1.6px rgba(245,244,242,.5);color:transparent;}
...
/* D5 — P + vertical rule + wordmark */
.d5 .lockup{display:flex;align-items:center;gap:clamp(18px,2.4vw,34px);}
.d5 .leadP{height:clamp(110px,15vw,220px);}
.d5 .rule{width:2px;align-self:stretch;background:linear-gradient(var(--pink),transparent);min-height:120px;}
.d5 h1{font-size:clamp(40px,5.4vw,92px);line-height:.82;}
...
@media(max-width:640px){.arrow{display:none;}.d4 .bleed{opacity:.16;}.d4 .left{padding-left:0;}}
@media(prefers-reduced-motion:reduce){*{animation:none!important;}}
</style>

<div class="tagline">W1 · drop-cap grande · P vermelho, só no hero <b id="tl">D1 · Inline em PORTO</b> · preview local</div>
<div class="deck">

  <!-- D1 -->
  <section class="slide active split d1" data-name="D1 · P inline em PORTO">
  ...
  <!-- D2 -->
  <section class="slide split d2" data-name="D2 · P gigante + wordmark">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
      <div class="lockup">
        <span class="leadP">__PM__</span>
        <div class="wcol">
          <div class="kick">Porto's #1 Pub Crawl</div>
          <h1>Porto<br>Pub<br>Crawl</h1>
        </div>
      </div>
  ...
  <!-- D3 -->
  <section class="slide split d3" data-name="D3 · P enorme como letra">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
  ...
  <!-- D4 -->
  <section class="slide split d4" data-name="D4 · P a sangrar da margem">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc">
  ...
  <!-- D5 -->
  <section class="slide split d5" data-name="D5 · P + régua + wordmark">
   <div class="hero"><video class="hbg hv" muted loop autoplay playsinline></video><div class="veil"></div>
    <div class="hc"><div class="left">
      <div class="lockup">
        <span class="leadP">__PM__</span>
        <div class="rule"></div>
        <h1>Porto<br>Pub Crawl</h1>
      </div>
...
<nav class="switch">
  <button class="on" data-i="0">D1 Inline</button>
  <button data-i="1">D2 Gigante</button>
  <button data-i="2">D3 Letra</button>
  <button data-i="3">D4 Sangra</button>
  <button data-i="4">D5 Régua</button>
</nav>
...
out=base/"hero-w1-preview.html";out.write_text(html)
